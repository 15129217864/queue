...
(function ($) {
    ...
    function processOptions(plot, options) {
        ...
        if (horizontal) {
            numbers.xAlign = numbers.xAlign || function (x) {
                    return x / 2;
                };
            numbers.yAlign = numbers.yAlign || function (y) {
                    return y + (bw / 2);
                };
    ...
    function drawSeries(plot, ctx, series) {
        if (series.bars.numbers.show || series.bars.showNumbers) {
            ...
            var shiftX = typeof xAlign == "number" ? function (x) {
                    return x;
                } : xAlign;
            var shiftY = typeof yAlign == "number" ? function (y) {
                    return y;
                } : yAlign;
